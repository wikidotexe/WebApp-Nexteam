		...
		<div class="row">
			<div class="col-8 mx-auto text-center">
				...
				<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
					...
					<li class="list-inline-item">/ &nbsp; <a wire:navigate href="{{ route('servicesPage') }}">Our Team</a>
					</li>
				</ul>
			</div>
		</div>
...
<section class="section teams text-center">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="section-title">
                    ...
                    <p class="mb-0">Kami adalah tim yang berdedikasi dengan keahlian dan semangat yang sama untuk mencapai kesuksesan. <br>Setiap anggota membawa keterampilan unik yang memperkuat kami dalam memberikan hasil terbaik untuk Anda. <br>Kenali lebih dekat orang-orang hebat di balik semua pencapaian ini!</p>
                </div>
            </div>
        </div>
